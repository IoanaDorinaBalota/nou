...
public class Admin {
	...
	private void initialize() {
		...
		frmAdmin.setBounds(100, 100, 770, 370);
		frmAdmin.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		
		JMenuBar menuBar = new JMenuBar();
		frmAdmin.setJMenuBar(menuBar);
		
		JMenuItem mntmStergeAngajat = new JMenuItem("Sterge angajat");
		menuBar.add(mntmStergeAngajat);
		...
		tabbedPane.setBounds(0, -32, 740, 325);
