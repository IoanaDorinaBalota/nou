...
public class AdminOperations {
	...
	public int login(String username,String pass)
	{
		...
		{
			System.out.println("ERoare gasire functie login");
			return -1;
			
		}
	}
	public void insertEmployee(String name,String identityCardNumber,String PNC,String address,String role,String username,String password)
	{
